...
def eval_on_dataset():
    ...
    # create 95%-CI
    dice_ci_1, _ = BCa_interval_macro_metric(dice_scores_total[0], func=lambda x: np.mean(x), B=10000)
    dice_ci_2, _ = BCa_interval_macro_metric(dice_scores_total[1], func=lambda x: np.mean(x), B=10000)
    dice_ci_3, _ = BCa_interval_macro_metric(dice_scores_total[2], func=lambda x: np.mean(x), B=10000)
