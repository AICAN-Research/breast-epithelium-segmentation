...
def masksPath = "/home/maren/fastpathology/projects/2023-02-07-140825_evaluate/results/"  // path to where TIFFs are stored (FastPathology project)
...
def classNames = ["invasive", "benign", "inSitu"]   // names of classes of interest (in this case two classes + background)
def taskName = "Multiclass epithelium segmentation in breast cancer"    // name of task, which correspond to which task that was run in FastPathology to get this result
