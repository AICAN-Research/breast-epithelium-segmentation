...
if __name__ == "__main__":
    ...
    stata_path = '/data/Maren_P1/data/STATA/STATA_Maren_P1_edited.dta'
    ...
    for file in os.listdir(dataset_path):
        ...
        # get histological subtype for case
        type_ = int(filtered_data["TYPE"])
    ...
    print("len 1: ", len(dice_types[0][0]), " mu 1 inv: ", np.mean(dice_types[0][0]), " mu 1 ben: ", np.mean(dice_types[0][1]), " mu 1 inv: ", np.mean(dice_types[0][2]))
    print("len 2: ", len(dice_types[1][0]), " mu 2 inv: ", np.mean(dice_types[1][0]), " mu 1 ben: ", np.mean(dice_types[1][1]), " mu 1 inv: ", np.mean(dice_types[1][2]))
    print("len 3: ", len(dice_types[2][0]), " mu 3 inv: ", np.mean(dice_types[2][0]), " mu 1 ben: ", np.mean(dice_types[2][1]), " mu 1 inv: ", np.mean(dice_types[2][2]))
    print("len 4: ", len(dice_types[3][0]), " mu 4 inv: ", np.mean(dice_types[3][0]), " mu 1 ben: ", np.mean(dice_types[3][1]), " mu 1 inv: ", np.mean(dice_types[3][2]))
    print("len 5: ", len(dice_types[4][0]), " mu 5 inv: ", np.mean(dice_types[4][0]), " mu 1 ben: ", np.mean(dice_types[4][1]), " mu 1 inv: ", np.mean(dice_types[4][2]))
    print("len 6: ", len(dice_types[5][0]), " mu 6 inv: ", np.mean(dice_types[5][0]), " mu 1 ben: ", np.mean(dice_types[5][1]), " mu 1 inv: ", np.mean(dice_types[5][2]))
    print("len 7: ", len(dice_types[6][0]), " mu 7 inv: ", np.mean(dice_types[6][0]), " mu 1 ben: ", np.mean(dice_types[6][1]), " mu 1 inv: ", np.mean(dice_types[6][2]))
    print("len 8: ", len(dice_types[7][0]), " mu 8 inv: ", np.mean(dice_types[7][0]), " mu 1 ben: ", np.mean(dice_types[7][1]), " mu 1 inv: ", np.mean(dice_types[7][2]))
